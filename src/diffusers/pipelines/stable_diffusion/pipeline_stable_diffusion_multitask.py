...
class StableDiffusionMultiTaskPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        if (mask_image is None and init_image is None):
            return super.__call_txt___(prompt, strength, num_inference_steps, guidance_scale, eta, generator, output_type,
            return_dict)

        if mask_image is None:
            return self.__call_img__(prompt, init_image, strength, num_inference_steps, guidance_scale, eta, generator, output_type,
            return_dict)

        else:
            return self.__call_mask__(prompt, init_image, mask_image, strength, num_inference_steps, guidance_scale, eta, generator, output_type,
            return_dict)
